...
<head>
    ...
    <title>Open to Work - Portofolio Adim</title>
</head>
...
<main>
            ...
            <div class="container">
                <div class="inner-content primary">
                    <article class="article-content cavalier">
                        <h1>I'am Adim, Freelance Full Stack Web Developer.</h1>
                        <p>I have worked on a variety of projects, ranging from small business websites to large-scale
                ...
                <div class="inner-content bottom">
                    <ul class="highlights" id="highlights-bottom">
                        <li><b>Backend & Database Specialization</b>: PHP Laravel, Javascript, NodeJs, MySQL, SQL Server
                            Management
                            <br><b>Frontend Specialization</b>: HTML, CSS, JQuery, Bootstrap, Tailwind, ReactJS, React
                            Native
                        </li>

                        <li><b>I am open to new projects </b> and would be happy to discuss your needs further.
                            Contact me today to see how I can help bring your web development project to life.</li>
                    </ul>
                </div>
            </div>
        </section>
    ...
    <div class="container">
        <div class="about-content">
            ...
            <h2 class="section-title">Korsa is a Creative Design Agency With Extensive Experience And Talented Team.</h2>
            <p class="section-description">We are the ones with the creative idea of creating stunning visuals that grab attention and leave a lasting impression!</p>
        </div>
            ...
            <div class="container">
                <div class="grids">
                    <div class="journey-info">
                        <div class="heading-journey">
                            <h2 class="heading">Services</h2>
                            <p class="text-heading">
                                I offer a range of services to clients looking to develop or improve their online
                                presence. Some of the key services I offer include:
                            </p>
                        </div>
                        <div class="skill-data">
                            <i class="uil uil-check-circle skill-check-icon"></i>
                            <div>
                                <h3 class="skill-name">Full Stack Web and Mobile Development</h3>
                                <p class="skill-text">
                                    I specialize in developing custom web and mobile applications using a variety
                                    development technologies, I work closely with clients to understand their needs and
                                    deliver solutions that meet their specific requirements. <br>
                                </p>
                            </div>
                        </div>
                        <hr>
                        <div class="skill-data">
                            <i class="uil uil-check-circle skill-check-icon"></i>
                            <div>
                                <h3 class="skill-name">Build an API according to requirements</h3>
                                <p class="skill-text">
                                    I am able to provide expert guidance and support throughout the entire API
                                    development process, ensuring that the client's API is customized to meet their
                                    specific needs and goals.
                                    Build API Design, API Architecture, Endpoints URL, Implementation, Documentation,
                    ...
                    <div class="journey-grid">
                        ...
                        <div class="skill-data">
                            <i class="uil uil-check-circle skill-check-icon"></i>
                            <div>
                                <h3 class="skill-name">Website Maintenance</h3>
                                <p class="skill-text">
                                    I offer ongoing website maintenance services to ensure that client websites are
                                    up-to-date, secure, and functioning properly. This includes regular backups,
                        ...
                        <div class="skill-data">
                            <i class="uil uil-check-circle skill-check-icon"></i>
                            <div>
                                <h3 class="skill-name">Project Management and IT Consulting</h3>
                                <p class="skill-text">
                                    I have extensive experience managing web development projects from start to finish.
                                    I can help clients define project goals, develop project plans, manage project
                                    timelines, and coordinate team members to ensure successful project completion.
                                </p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 my-project-info">
                        <div class="my-project-top">
                            <h2 class="heading-project">Project Completed</h2>
                            <p class="text-heading-project">Some projects I've worked on and have finished, project
                        ...
                        <div class="my-project-bottom">
                            <div class="card">
                                <div class="card-heading">
                                    <img alt="development" src="{{ asset('assets/img/logo-bootcamp.jpeg') }}" width="40"
                                        height="40">

                                    <span>E-Learning Bootcamp Web App</span>
                                </div>

                                <p>Web-based application that supports members to join online training or bootcamp.
                                    This application provides <b>many courses</b> to increase knowledge and hone hard
                                    skills of members and job vacancies.
                                </p>

                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('bootcamp') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-heading">
                                    <img alt="interaction" src="{{ asset('assets/img/e-bengkel.png') }}" width="40"
                                        height="40">
                                    <span>E-Bengkel Terintegrasi </span>
                                </div>

                                <p>E-Bengkel is a <b>Web Application</b> in supporting the management of a workshop and having nine modules
                                    that are integrated with each other, including the Single Sign-on module, Front
                                    Office, Point of Sales, Service, Inventory & Purchasing, Staffing, Payroll,
                                    Accounting and Finance and Marketplace. </p>

                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('bengkel') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="creative production" src="{{ asset('assets/img/logo-pajak.png') }}"
                                        width="60" height="30">
                                    <span>Payroll Web App</span>
                                </div>

                                <p>Payroll web app is an application to make it easier for treasurers to <b>manage
                                        employee salary</b> at KPP Pratama Gianyar Bali</p>

                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('payroll') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="visual branding" src="{{ asset('assets/img/logo-pelindo.png') }}"
                                        width="40" height="40">
                                    <span>HRD Staffing Web App</span>
                                </div>
                                <p>HRD staffing web app is a web-based application that is useful for <b>facilitating
                                        personnel management</b> at PT. Pelindo III. There are 14 features and 7 user
                                    roles to support this application.</p>
                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('hrd') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="creative production" src="{{ asset('assets/img/logo-riasta.png') }}"
                                        width="60" height="30">
                                    <span>Money Changer Cashier</span>
                                </div>

                                <p>Money Changer Cashier is a web-based application to support all <b>cashier
                                        transactions and accounting reporting</b> at PT. Riastavalasindo </p>

                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('kasir') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="visual branding" src="{{ asset('assets/img/logo-suksesberkah.png') }}"
                                        width="40" height="30">
                                    <span>Inventory & Sales Gas Supplier</span>
                                </div>
                                <p>Inventory & Sales Gas Supplier is a web application to support the <b>entire supply
                                        and sale of gas and aqua products</b> at PT Suksesberkahbertmbuh. This
                                    application has 10 features and 3 user roles</p>
                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('inventory') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="visual branding" src="{{ asset('assets/img/tv.png') }}" width="40"
                                        height="40">
                                ...
                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('movie') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card">
                                <div class=" card-heading">
                                    <img alt="visual branding" src="{{ asset('assets/img/travel.png') }}" width="40"
                                        height="40">
                                ...
                                <div class="projects">
                                    <p>Detail Project: </p>
                                    <ul>
                                        <li><a href="{{ route('travel') }}">Click for Detail</a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="grids">
                    <div class="contact-info">
                        ...
                        <p class="text-heading">
                            ...
                            Hopefully we can match each other and can work together. Thank You!
                        </p>
